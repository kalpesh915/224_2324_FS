...
$unreadMessageCount = $adminusers->getUnreadMessageCount();
?>
<nav class="header-nav ms-auto">
    <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
            ...
            <a class="nav-link nav-icon" href="unreadmessages" data-bs-toggle="dropdown">
                <i class="bi bi-chat-left-text"></i>
                <span class="badge bg-success badge-number"><?= $unreadMessageCount; ?></span>
            </a><!-- End Messages Icon -->

            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
                <li class="dropdown-header">
                    You have <?= $unreadMessageCount; ?> new messages
                    <a href="unreadmessages"><span class="badge rounded-pill bg-primary p-2 ms-2">View all</span></a>
                </li>
                <li>
                    <hr class="dropdown-divider">
                </li>
                ...
                <?php
                $result = $adminusers->getSomeMessages(3);
        ...
        <li class="dropdown-footer">
            <a href="unreadmessages">Show all messages</a>
        </li>
