...
if (isset($_POST["changeProcess"])) {
    $newpassword = $client->filterData($_POST["newpassword"]);
    $confirmpassword = $client->filterData($_POST["confirmpassword"]);

    if ($newpassword == $confirmpassword) {

        $newpassword = password_hash($newpassword, PASSWORD_DEFAULT);
        $client->changePassword($_SESSION["resetemail"], $newpassword);
